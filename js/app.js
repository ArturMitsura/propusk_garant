(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".control-page-thumb__slider")) {
            const thumbsSwiper = new core(".control-page-thumb__slider", {
            ...
            new core(".control-page__slider", {
                modules: [ Navigation, EffectCreative, Thumb ],
                direction: "vertical",
                observer: true,
                observeParents: true,
                slidesPerView: 1,
    ...
    let sub_item = document.querySelectorAll(".menu__item_sub");
    for (let i = 0; i < sub_item.length; i++) {
        let thisLink = sub_item[i];
        let subMenu = sub_item[i].lastElementChild;
        thisLink.classList.add("parent");
        sub_item[i].addEventListener("click", (function() {
